...
let actionsFunction = {
  ...
  // Find by user_accounts
  findByuser_accounts: function(key) {
    return function(dispatch) {
      return UserApi
        .findByuser_accounts(key)
        .then(item => {
          dispatch(actionsFunction.findByuser_accountsSuccess(item));
        })
        .catch(error => {
          throw error;
        });
  ...
  findByuser_accountsSuccess: function(item) {
    return { type: types.FINDBYUSER_ACCOUNTS_USER_SUCCESS, payload: item };
  },
